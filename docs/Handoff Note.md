...
- 已新增并运行 `Code/dong2012_plasma_boundary.py`，把 Dong2012 Eq. (2) 中 $\nu_p$ 与载流子浓度 $N$ 的关系转成可复现换算。输出见 `Experiments/outputs/dong2012_plasma_boundary_table.csv`、`Experiments/outputs/dong2012_plasma_boundary_summary.md` 和 `Writing/nu_p物理边界与优化约束-2026-05-04.md`。
