...
综合数据处理、FOD/FFT 初值、Dong/TMM 全谱拟合、参数敏感性、残差诊断和波段权重分析，本文认为 SiC 外延层厚度的当前最强候选区间为
\begin{equation}
\boxed{
